...
> 3. Replace `/usr/bin/git` with the git path you got from [[Personal/Writings/Technical/Digital Forensics/How to Manage Multiple Git Credential for the Same Provider#Know your current git path\|here]].
